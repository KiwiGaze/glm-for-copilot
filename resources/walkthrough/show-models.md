Your GLM models appear in the Copilot Chat model picker as soon as the extension is active. The picker shows only the models available for your selected **API Mode** — GLM-5.3 (the default), GLM-5.2, GLM-4.7, and GLM-4.5 Air on the Coding Plan, or GLM-5.2, GLM-5.1, GLM-5, GLM-4.7, and GLM-4.5 Air on the Standard API.
