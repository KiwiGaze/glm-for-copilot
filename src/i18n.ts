...
const en: Record<string, string> = {
	...
	'visionMcp.install.success': 'GLM Vision installed. It starts automatically with your next chat message.',
	...
	'visionMcp.npx.missing':
		'Node.js 18+ (22+ recommended) with npx was not found on PATH. The GLM Vision server needs Node.js to run.',
	'visionMcp.npx.tooOld':
		'Node.js {0} was found, but the GLM Vision server needs Node.js {1}+ (22+ recommended). It may fail to start.',
	'visionMcp.npx.installAnyway': 'Install Anyway',
	'visionMcp.npx.requirements': 'Requirements',
	'visionMcp.cancel': 'Cancel',
	'visionMcp.uninstall.done': 'GLM Vision uninstalled. Chat models are text-only again.',
...
const zh: Record<string, string> = {
	...
	'visionMcp.install.success': 'GLM Vision 已安装。它会在你发送下一条聊天消息时自动启动。',
	...
	'visionMcp.notNow': '暂不',
	'visionMcp.npx.missing': '未在 PATH 中找到 Node.js 18+（推荐 22+）和 npx。GLM Vision 服务器需要 Node.js 才能运行。',
	'visionMcp.npx.tooOld': '检测到 Node.js {0}，但 GLM Vision 服务器需要 Node.js {1} 及以上版本（推荐 22+），可能无法启动。',
	'visionMcp.npx.installAnyway': '仍然安装',
	'visionMcp.npx.requirements': '环境要求',
	'visionMcp.cancel': '取消',
	'visionMcp.uninstall.done': 'GLM Vision 已卸载。聊天模型已恢复为纯文本。',
